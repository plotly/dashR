...
> :stop: Make sure you're on at least version `3.5` of R. You can see what version of R you have by entering `version` in the R CLI. [https://cran.r-project.org/bin/](CRAN) is the easiest place to download the latest R version.
