...
def test_rsdp001_dopsa(dashr):
    ...
    dashr.wait_for_text_to_equal(
        "#output-state", "The Button has been pressed '0' times, Input 1 is 'Montreal', and Input 2 is 'Canada'", timeout=1
    )
    ...
    dashr.wait_for_text_to_equal(
        "#output-state", "The Button has been pressed '1' times, Input 1 is 'Montreal', and Input 2 is 'Quebec'", timeout=1
    )
