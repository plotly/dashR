...
ui <- htmlDiv(
  ...
  coreMarkdown(
    "DashR apps are composed of two parts. The first part is the '`layout`' of",
    "the app and it describes what the application looks like.",
    "The second part describes the interactivity of the application.",
    "",
    "DashR provides R functions for all of the visual components of",
  ...
  coreMarkdown(
    ...
    "DashR is _declarative_: you will primarily describe your application",
  ...
  coreMarkdown(
    ...
    "",
    "1. The `style` property in HTML is a semicolon-separated string. In DashR, you can supply a named list.",
    ...
    "3. The HTML `class` attribute is `className` in DashR.",
  ...
  coreMarkdown(
    ...
    "",
    "Like all DashR components, they are described declaratively.",
