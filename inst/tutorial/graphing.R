...
updating time series when we hover over points in our scatter plot."
  ...
  coreMarkdown(
    ...
    "Notice how the line graphs on the right update based off of the point",
  ...
  Syntax(
    examples[[3]]$source,
    "Here's a slightly more generic example for crossfiltering across a six",
    "column data set. Each scatter plot's selection filters the underlying dataset."
  ),
  ...
  coreMarkdown(
    ...
    "highly-dimensional datasets, consider checking out the",
