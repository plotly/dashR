...
Dasher is an R package for building reactive web applications. It builds upon many
...
Dasher is an open source library, released under the permissive MIT license.
[Plotly](https://plot.ly) develops Dasher and offers a platform for deploying,
