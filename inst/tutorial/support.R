...
ui <- coreMarkdown(
  "# DashR Support and Contact",
  "",
  "DashR is an open-source product that is",
  "developed and maintained by [Plotly](https://plot.ly).",
  "",
  "### DashR Demos and Enterprise Trials",
  "",
  "If you would like to trial or purchase a DashR On-Premises server,",
  ...
  "a demo of DashR and DashR On-Premises too.",
  "",
  "### DashR Workshops",
  "",
