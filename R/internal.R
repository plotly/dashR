.dash_js_metadata <- function() {
  deps_metadata <- list(`react-prod` = structure(list(name = "react",
                                                      ...
                                                      meta = NULL,
                                                      script = "react@16.8.6/umd/react.production.min.js",
                                                      stylesheet = NULL,
                                                      head = NULL,
                                                      attachment = NULL,
                                                      package = "dash",
                        ...
                        `react-dom-prod` = structure(list(name = "react-dom",
                                                          ...
                                                          meta = NULL,
                                                          script = "react@16.8.6/dist/react-dom.production.min.js",
                                                          stylesheet = NULL,
                                                          head = NULL,
                                                          attachment = NULL,
                                                          package = "dash",
                        ...
                        `polyfill-prod` = structure(list(name = "polyfill",
                                                    ...
                                                    meta = NULL,
                                                    script = "polyfill@7.7.0/dist/polyfill.min.js",
                                                    stylesheet = NULL,
                                                    head = NULL,
                                                    attachment = NULL,
                                                    package = "dash",
                        ...
                        `dash-renderer-dev` = structure(list(name = "dash-renderer",
                                                         ...
                                                         meta = NULL,
                                                         script = "dash-renderer@1.2.2/dash-renderer/dash_renderer.dev.js",
                                                         stylesheet = NULL,
                                                         head = NULL,
                                                         attachment = NULL,
                                                         package = "dash",
                        ...
                        `dash-renderer-map-dev` = structure(list(name = "dash-renderer",
                                                         ...
                                                         src = list(href = "https://unpkg.com/dash-renderer@1.2.2",
                                                                    file = "lib/dash-renderer@1.2.2"),
                                                         meta = NULL,
                                                         script = "dash-renderer@1.2.2/dash-renderer/dash_renderer.dev.js.map",
                                                         stylesheet = NULL,
                                                         head = NULL,
                                                         attachment = NULL,
                                                         package = "dash",
                        ...
                        `dash-renderer-prod` = structure(list(name = "dash-renderer",
                                                         ...
                                                         src = list(href = "https://unpkg.com/dash-renderer@1.2.2",
                                                                    file = "lib/dash-renderer@1.2.2"),
                                                         meta = NULL,
                                                         script = "dash-renderer@1.2.2/dash-renderer/dash_renderer.min.js",
                                                         stylesheet = NULL,
                                                         head = NULL,
                                                         attachment = NULL,
                                                         package = "dash",
                        ...
                        `dash-renderer-map-prod` = structure(list(name = "dash-renderer",
                                                         ...
                                                         src = list(href = "https://unpkg.com/dash-renderer@1.2.2",
                                                                    file = "lib/dash-renderer@1.2.2"),
                                                         meta = NULL,
                                                         script = "dash-renderer@1.2.2/dash-renderer/dash_renderer.min.js.map",
                                                         stylesheet = NULL,
                                                         head = NULL,
                                                         attachment = NULL,
                                                         package = "dash",
                        ...
                        `prop-types-dev` = structure(list(name = "prop-types",
                                                          ...
                                                          meta = NULL,
                                                          script = "prop-types@15.7.2/prop-types/prop-types.js",
                                                          stylesheet = NULL,
                                                          head = NULL,
                                                          attachment = NULL,
                                                          package = "dash",
                        ...
                        `prop-types-prod` = structure(list(name = "prop-types",
                                                           ...
                                                           src = list(href = "https://unpkg.com/prop-types@15.7.2",
                                                                      file = "lib/prop-types@15.7.2"),
                                                           meta = NULL,
                                                           script = "prop-types@15.7.2/prop-types/prop-types.min.js",
                                                           stylesheet = NULL,
                                                           head = NULL,
                                                           attachment = NULL,
                                                           package = "dash",
