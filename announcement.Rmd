...
4. More granular updates

During [shiny's flush cycle](https://cran.r-project.org/web/packages/promises/vignettes/shiny.html), an update is not performed until *all* output values are ready. In dashR, updates are performed as soon as they are ready (and can be performed in parallel). This means, in some cases, you may need to be more thoughtful during development to ensure a good user experience, but it also offers you more control over what's happening during an update.
...
6. Apps can be serialized as JSON
  * saving and loading
